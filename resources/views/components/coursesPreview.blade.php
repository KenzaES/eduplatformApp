<div class="py-16">  
    <div class=" ml-4 px-6 text-gray-500 md:px-12 xl:px-0 ">
        <div class="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3 ">
            <div class="bg-white rounded-2xl border-4 border-indigo-800 shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                ...
                <div class="flex items-center">
                  <img class="w-10 h-10 rounded-full mr-4" src="{{ asset('images/portrait-smiling-blonde-woman.jpg') }}" alt="Avatar of Writer">
                  <div class="text-sm">
                    <p class="text-gray-900 leading-none">Rafael Martin</p>
                    <p class="text-gray-600">Expert in Cybersecurity</p>
                  </div>
                </div>
            </div>
            <div class="bg-white rounded-2xl border-4 border-indigo-500 shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
            ...
            <div class="bg-white rounded-2xl border-4 border-indigo-300 shadow-xl mr-4 px-8 py-12 sm:px-12 lg:px-8">
                <div class="mb-12 space-y-4">
