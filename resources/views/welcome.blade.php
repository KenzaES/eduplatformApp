  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
                <a href="{{ route('register') }}" class="text-lg text-blue-400  inline-block py-2 px-4 font-bold no-underline">Register</a>
            </li>
            <li class="mr-3">
          ...
          >
          <a href="{{ route('login') }}" class="px-4 py-2">Log in</a>
          </button>
        </div>
      </div>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5  justify-center items-center text-center md:text-left">
          ...
          <h1 class="my-4 px-12 text-4xl font-bold bg-clip-text text-white">
            the only limit is yourself!
          </h1>
          
          <p class="leading-normal text-2xl ">
            Connect you to start new adventure !
          </p>
          <p class="uppercase  px-20 tracking-loose w-full italic mb-8 text-sm">Bring yourself to the next step of your skills!</p>
          <div class="">
            @if (Route::has('login'))
            <div class="space-x-8">
                @auth
                    <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    <a href="{{ url('/dashboard') }}" class="text-sm text-gray-700 dark:text-gray-500 no-underline">Go to your work space</a>
                    </button>
                    @else
                    <button class="mx-auto lg:mx-0 hover:bg-indigo-500  bg-white  font-bold rounded-full my-6 py-4 px-8 shadow-lg hover:text-slate-300 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                    <a href="{{ route('login') }}" class="text-lg text-blue-400 px-4 no-underline hover:text-white">Log in</a>
                    </button>
                    @if (Route::has('register'))
                    <button class="mx-auto lg:mx-0 hover:bg-indigo-500 bg-white  font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                        <a href="{{ route('register') }}" class="ml-4 text-lg text-blue-400 dark:text-gray-500 no-underline hover:text-white">Register</a>
                    </button>
                        @endif
                @endauth
            </div>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
            <img class="w-full md:w-4/5 z-50"src="{{ asset('images/Launching-pana.svg') }}" >
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        We offer great courses, but we also will be happy to count you among our Heroes!
      </h3>
      <div class="">
        @if (Route::has('login'))
        <div class="space-x-8">
