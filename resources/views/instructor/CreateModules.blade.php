        ...
        <!-- END Right Section -->
          ...
          <main class="p-6 sm:p-10 space-y-6">
            <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                <div class="mr-6">
                  <h1 class="text-4xl font-semibold mb-2"> {{ __('Create courses Modules') }}</h1>
                  <h2 class="text-gray-600 ml-0.5">Let's enrich our course!</h2>
                </div>
            ...
            <section class="grid md:grid-cols-2 gap-20"  >
              
              
            {{-- form module section --}}
            <div  class="max-w-4xl p-6 mx-auto bg-cyan-600 rounded-md shadow-md dark:bg-gray-800 mt-4 ">
                <h1 class="text-xl font-bold text-white capitalize dark:text-white">Course Content</h1>
                <form action="{{ route('store.modules') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  ...
                  <input type="hidden" name="course_id" value="{{ $course_id }}">
                    <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label class="text-white dark:text-gray-200" for="moduleNumber">Module Number </label>
                            <input id="moduleNumber" name="moduleNumber" type="number" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                        </div>
                        <div>
                            <label class="text-white dark:text-gray-200" for="titl">Title</label>
                        ...
                        <div>
                            <label class="text-white dark:text-gray-200" for="content"> Course Video</label>
                            <input id="url" type="url" name="video" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></input>
                        </div>                        
                        <div>
                            <label class="text-white dark:text-gray-200" for="content"> Module's body</label>
                            <textarea id="textarea" type="textarea" name="content" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
                        </div>
                          ...
                          <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                            <div class="space-y-1 text-center">
                              ...
                              <div class="flex text-sm text-gray-600">
                                <label for="module_image" class="relative cursor-pointer bg-white rounded-md font-medium text-cyan-600 hover:text-white hover:bg-blue-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                                  <span class="">Upload module image</span>
                                  <input id="module_image" name="module_image" type="file" class="sr-only">
                                </label>
                    ...
                    <div class="flex space-x-4 justify-end mt-6">
                      <input type="hidden" name="action" value="save">
                        <button type="submit" name="submit_action" value="add_more" class="flex px-6 py-2 leading-5 text-cyan-600  transition-colors duration-200 transform bg-amber-500 rounded-md hover:bg-sky-700 focus:outline-none focus:bg-gray-600">
                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255);transform: ;msFilter:;"><path d="M4 22h12v-2H4V8H2v12c0 1.103.897 2 2 2z"></path><path d="M20 2H8c-1.103 0-2 .897-2 2v12c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2V4c0-1.103-.897-2-2-2zm-2 9h-3v3h-2v-3h-3V9h3V6h2v3h3v2z"></path></svg>
                             Add More Module </button>
                             {{-- <button type="button" onclick="previousSection()" class="flex px-6 py-2 leading-5 text-cyan-600 transition-colors duration-200 transform bg-amber-500 rounded-md hover:bg-sky-700 focus:outline-none focus:bg-gray-600">
                                Back
                            </button> --}}
                            <button type="submit" name="submit_action" value="save" class="flex px-6 py-2 leading-5 text-cyan-600 transition-colors duration-200 transform bg-blue-200 rounded-md hover:bg-sky-700 focus:outline-none focus:bg-gray-600">
                                Save
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255);"><path d="M5 21h14a2 2 0 0 0 2-2V8l-5-5H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2zM7 5h4v2h2V5h2v4H7V5zm0 8h10v6H7v-6z"></path></svg>
                            </button>
...
<div class="  hidden md:flex  text-gray-300">
  <img class="w-full md:w-4/5 z-50"src="{{ asset('images/modulecreate.svg') }}" >
</div>        
</section>
