          ...
          <main class="p-6 sm:p-10 space-y-6">
            ...
            <div class="max-w-4xl p-6 mx-auto bg-cyan-600 rounded-md shadow-md dark:bg-gray-800 ">
                ...
                <form action="{{ route('update.course', ['id' => $course->id]) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <!-- Category -->
                  <div>
                      <label for="category" class="text-white dark:text-gray-200">Category</label>
                      <select id="category" name="category" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" required>
                          ...
                          <option value="Math" {{ old('category', $course->category) === 'Math' ? 'selected' : '' }}>Math</option>
                          <option value="WebDevelopment" {{ old('category', $course->category) === 'WebDevelopment' ? 'selected' : '' }}>Web Development</option>
                          <option value="Cybersecurity" {{ old('category', $course->category) === 'Cybersecurity' ? 'selected' : '' }}>Cybersecurity</option>
                          <option value="IA" {{ old('category', $course->category) === 'IA' ? 'selected' : '' }}>IA</option>
                  ...
                  <!-- Duration -->
                  <div>
                      <label for="duration" class="text-white dark:text-gray-200">Duration in hour</label>
                      <input id="duration" name="duration" type="time" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"
                  ...
                  <!-- Language -->
                  <div>
                      <label for="language" class="text-white dark:text-gray-200">Language</label>
                  ...
                  <!-- Complexity -->
                  <div>
                      <label class="text-white dark:text-gray-200">Complexity</label>
                      <div class="flex justify-around text-white dark:text-gray-200">
                          <label>
                              <input type="radio" name="complexity" value="easy" {{ old('complexity', $course->complexity) === 'easy' ? 'checked' : '' }} required>
                              <span>Easy</span>
                          </label>
                          <label>
                              <input type="radio" name="complexity" value="medium" {{ old('complexity', $course->complexity) === 'medium' ? 'checked' : '' }} required>
                              <span>Medium</span>
                          </label>
                          <label>
                              <input type="radio" name="complexity" value="hard" {{ old('complexity', $course->complexity) === 'hard' ? 'checked' : '' }} required>
                              <span>Hard</span>
                          </label>
                      </div>
                  </div>
                  ...
                  <!-- Requirement -->
                  <div>
                      <label for="requirement" class="text-white dark:text-gray-200">Requirements</label>
                      <textarea id="requirement" name="requirement" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" required>{{ old('requirement', $course->requirement) }}</textarea>
                      @error('requirement')
                      <span class="text-red-500">{{ $message }}</span>
                      @enderror
                  </div>
                  ...
                  <div>
                      ...
                      <textarea id="description" name="description" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">{{ old('description', $course->description) }}</textarea>
                      @error('description')
                      <span class="text-red-500">{{ $message }}</span>
                      @enderror
                  </div>
                  ...
                  <div class="flex justify-end mt-6">
                      <button type="submit" class="flex px-6 py-2 leading-5 text-cyan-600 transition-colors duration-200 transform bg-blue-200 rounded-md hover:bg-sky-700 focus:outline-none focus:bg-gray-600">Update
