...
<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="rgb(2 ,132,199)" class="h-6 w-6"><path d="M300-180v-200l160 100-160 100Zm220-380q-50 0-85-35t-35-85q0-50 35-85t85-35h50v60h-50q-25 0-42.5 17.5T460-680q0 25 17.5 42.5T520-620h50v60h-50Zm110 0v-60h50q25 0 42.5-17.5T740-680q0-25-17.5-42.5T680-740h-50v-60h50q50 0 85 35t35 85q0 50-35 85t-85 35h-50Zm-110-90v-60h160v60H520Zm124 250v-80h196v-360H360v360h-80v-360q0-33 23.5-56.5T360-920h480q33 0 56.5 23.5T920-840v360q0 33-23.5 56.5T840-400H644ZM120-40q-33 0-56.5-23.5T40-120v-320q0-33 23.5-56.5T120-520h480q33 0 56.5 23.5T680-440v320q0 33-23.5 56.5T600-40H120Zm0-80h480v-320H120v320Zm480-540ZM360-280Z"/></svg>
      ...
      <div class="relative inline-block">
        ...
        >
          ...
          >
            <div>
              <h2 class="mb-0.5 font-semibold">All Courses</h2>
              <h3 class="text-sm font-medium text-zinc-600">
                You have {{ $userCourseCount }} courses.
              </h3>
            </div>
            <div>
              <a
                href="{{ route('create.courses') }}"
                class="inline-flex items-center justify-center gap-1.5 rounded-lg border border-cyan-600 bg-cyan-600 px-3 py-2 text-sm font-semibold leading-5 text-white hover:border-cyan-700 hover:bg-cyan-700 active:border-cyan-600 active:bg-cyan-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
              ...
              <table class="min-w-full align-middle text-sm">
                ...
                <tbody>
                  ...
                  <tr class=" border-b border-zinc-100 hover:bg-zinc-50">
                    <td
                      class="flex space-x-2 p-3 text-start font-semibold text-zinc-600"
                    >
                    <div>
                      @if ($course ->course_image)
                      
                      <img src="{{ asset('images/' . $course->course_image) }}" alt="Course Image" class="hidden sm:inline-block h-12 w-12 rounded-full"/>
                    ...
                    <td class="p-3 ml-4 font-medium text-zinc-600">
                      <div
                    ...
                    <td class="p-3 text-start">{{$course->duration}}</td>
                    <td
                    ...
                    <a 
                      href="{{ route('edit.course', ['id' => $course->id]) }}"
                        class="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm font-semibold leading-5 text-zinc-800 hover:bg-lime-400 hover:text-zinc-950 active:border-zinc-200"
                      >
                      ...
                      <form action="{{ route('delete.course', $course->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="inline-flex items-center justify-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm font-semibold leading-5 text-zinc-800 hover:bg-red-300 hover:text-zinc-950 active:border-zinc-200">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
